...
//Also calculate bandwidth based on either nyquist or shannon,
//latency & throughput.
...
void latency()
{
	...
	cout<<"What is the propagation speed in m/s? (2.4 * 10^8 m/s -> standard)\n";
	cin>>prop_speed;   
	
	float prop_time = ((dist * 1000)/((float) prop_speed));
	cout<<"Propagation Time : "<<prop_time*100<<" ms"<<endl;
